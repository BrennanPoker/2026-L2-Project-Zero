...
def Instructions():
    print(make_statement(statement="Instructions", decoration="🎉"))
...
# Initialise variables / non-default options from string checker
...
print(make_statement(statement="Mini-Movie Fundraiser Program", decoration="🎉"))
...
while tickets_sold < MAX_TICKETS:
    ...
    # ask user for their payment method (cash / credit / ca / cr)
...
if tickets_sold == MAX_TICKETS:
    num_sold_string = make_statement(statement= f"You have sold all the tickets "
                                     f"(ie: {MAX_TICKETS} tickets)", decoration="-")
else:
    num_sold_string = make_statement(statement= f"You have sold {tickets_sold} "
                                     f"out of {MAX_TICKETS} tickets.", decoration="-")
...
adjusted_sales_heading = make_statement(statement="Adjusted Sales & Profit",
                                        decoration="-")
adjusted_explanation = (f"We have given away a ticket worth ${ticket_won:.2f} which means \n our"
                        f"sales have decreases by ${ticket_won:.2f} and our profit \n"
